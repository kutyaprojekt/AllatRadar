...
const AdminPanelPostsTemplate = ({ animal, onEdit, onView }) => {
  ...
  return (
    <div className={`relative flex flex-col rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-all ${
      ...
      <div className={`flex divide-x ${
        theme === "dark" ? "border-t border-gray-700 divide-gray-700" : "border-t border-gray-200 divide-gray-200"
      }`}>
        <button

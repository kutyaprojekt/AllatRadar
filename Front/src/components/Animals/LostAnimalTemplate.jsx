    ...
    return (
        <div className={`${theme === "dark" ? "bg-gray-800 border-gray-700 border-2" : "bg-white"} rounded-xl shadow-lg overflow-hidden border ${theme === "dark" ? "" : "border-gray-200"} w-[350px] mx-auto flex flex-col h-full`}>
            <div className="w-full h-64 overflow-hidden relative">
                ...
                <span className={`absolute top-0 right-0 mt-3 mr-3 px-2 py-1 rounded-full text-xs font-semibold ${theme === "dark" ? "bg-red-800" : "bg-red-100 text-red-800"}`}>
                    Elveszett
                </span>
            </div>
            ...
            <div className="p-5 flex flex-col flex-grow">
                ...
                <div className="mb-4">
                    <div className={`${theme === "dark" ? "bg-gray-900 border border-gray-700" : "bg-gray-50"} p-3 rounded-lg`}>

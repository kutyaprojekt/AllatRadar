        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/aboutus" className="text-gray-400 hover:text-white">Rólunk</a></li>
              <li><a href="/howitworks" className="text-gray-400 hover:text-white">Hogyan Működik?</a></li>
              <li><a href="/gyik" className="text-gray-400 hover:text-white">GYIK</a></li>
              <li><a href="/contactus" className="text-gray-400 hover:text-white">Kapcsolat</a></li>
            </ul>
          </div>
